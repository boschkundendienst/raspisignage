...
/usr/bin/chromium --disable-features=TranslateUI --disable-features=Translate --disable-breakpad --start-fullscreen --incognito --no-first-run --disable-session-crashed-bubble --temp-profile --disable-infobars --noerrdialogs --noerrors --kiosk --no-xshm \$url &
