...
#
packages="fbida,fluxbox,xorg-server,xf86-video-fbdev,xorg-xmodmap,xorg-xinit,xorg-xset,xorg-xmessage,accountsservice,lightdm,lightdm-gtk-greeter,unclutter,firefox,chromium,ttf-liberation,ttf-dejavu,feh,alsa-tools,alsa-utils,alsa-firmware,youtube-dl,yt-dlp,rtmpdump,python-pycryptodome,omxplayer-git,vim,cronie" # noto-fonts,noto-fonts-cjk,noto-fonts-emoji,noto-fonts-extra"
...
#/usr/bin/chromium --autoplay-policy=no-user-gesture-required --ignore-certificate-errors --disable-features=TranslateUI --disable-features=Translate --disable-breakpad --start-fullscreen --incognito --no-first-run --disable-session-crashed-bubble --temp-profile --disable-infobars --noerrdialogs --noerrors --kiosk --no-xshm --no-shm --disable-gpu \$url &
